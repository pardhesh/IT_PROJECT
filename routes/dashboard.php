...
<html>
    ...
    <body>
            ...
            <a href="logout.php"><button class="gradient-button gradient-button-2"><b>Logout</b></button></a>
            ...
            <div id="mainSection">
                ...
                <center><h2><b>PROFILE</b></h2></center><hr>
                    <center><img src="../uploads/<?php echo $data['photo']?>" height="150" width="175"></center><br><br>
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        ?>
                            <div style="border-bottom: 1px solid #bdc3c7; margin-bottom: 10px">
                                <b>NO CANDIDATES ARE COMPETING RIGHT NOW.</b>    
                            </div>
                        <?php
                    }  
                    ?>
